...
resourcename="dogwalkingsystem"  # lower case, only
resourcegroup="dogwalkingsystem_rg"
...
# git clone https://github.com/apilogicserver/dogwalkingsystem.git
# cd dogwalkingsystem
...
az group create --name dogwalkingsystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dogwalkingsystem_rg --sku S1 --is-linux
az container create --resource-group dogwalkingsystem_rg --name dogwalkingsystem --image apilogicserver/dogwalkingsystem:latest --dns-name-label dogwalkingsystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dogwalkingsystem.westus.azurecontainer.io:5656'
